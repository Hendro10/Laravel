<?php
  ...
  $query = "CREATE DATABASE IF NOT EXISTS universitas";
  ...
  if(!$result){
    ...
    echo "Database <b>'universitas'</b> berhasil dibuat... <br>";
  }

  //pilih database universitas
  $result = mysqli_select_db($link, "universitas");
  ...
  if(!$result){
    ...
    echo "Database <b>'universitas'</b> berhasil dipilih... <br>";
  }
